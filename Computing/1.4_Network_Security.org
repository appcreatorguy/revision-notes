...
+ *Active Attacks*, where someone attacks a network with [[Malware]] or other planned attacks.
  - These are more easily detected, and the main defence is a *firewall*
+ *<<Insider Attacks>>*, where someone within an organisation exploits their access to steal information.
